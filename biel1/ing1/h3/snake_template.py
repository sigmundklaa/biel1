...
def draw_snake_pixel(pos):
    draw_pixel(pos, SNAKE_COLOR)
...
def spawn_food(snake_segments, foods):
    ...
    while 1:
        ...
        if pos in snake_segments or pos in foods:
            continue

        break

    foods.append(pos)
    draw_pixel(pos, FOOD_COLOR)
    # --------------------------------
